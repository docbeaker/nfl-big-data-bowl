...
Welcome to `nfl-big-data-bowl` contributor's guide.
...
If you experience bugs or general issues with `nfl-big-data-bowl`, please have a look
...
You can help improve `nfl-big-data-bowl` docs by making them more readable and coherent, or
by adding missing information and correcting mistakes.

`nfl-big-data-bowl` documentation uses [Sphinx] as its main documentation compiler.
...
```{todo} If your project is hosted on GitHub, you can also mention the following tip:
   ...
   :::{tip}
      ...
      propose changes in `nfl-big-data-bowl`'s files. While this mechanism can
...
```
conda create -n nfl-big-data-bowl python=3 six virtualenv pytest pytest-cov
conda activate nfl-big-data-bowl
```
...
3. Clone this copy to your local disk:
   ...
   ```
   git clone git@github.com:YourLogin/nfl-big-data-bowl.git
   cd nfl-big-data-bowl
   ```
...
5. Install [pre-commit]:
   ...
   `nfl-big-data-bowl` comes with a lot of hooks configured to automatically help the
...
[repository]: https://github.com/<USERNAME>/nfl-big-data-bowl
[issue tracker]: https://github.com/<USERNAME>/nfl-big-data-bowl/issues
